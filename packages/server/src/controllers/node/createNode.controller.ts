...
export const createNodeController = (createNode: CreateNode) => (
  async (req: Request<{}, {}, SnakeCase<CreateNodeBody>>, res: TypedResponse<SnakeCase<Node>>): Promise<TypedResponse<SnakeCase<Node>>> => {
