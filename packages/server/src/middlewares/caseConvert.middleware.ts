      ...
      if (parsedData) {
        if (Array.isArray(parsedData.payload)) {
          data = {
            ...
            payload: parsedData.payload.map((item: any) => toCamelCase(item)),
          ...
          data = {
            message: parsedData.message,
            payload: toCamelCase(parsedData.payload),
            success: parsedData.success,
            issues: parsedData.issues,
          }
